    ...
    <main class="text-center">
        ...
        <div class="about-sections flex-center dir-col">
            <div class="row row-1 flex-center dir-change">
                <section id="bio" class="about-section flex" aria-labelledby="bio-title">
                    <h2 id="bio-title">Bio</h2>
                    <?= $bio ?>
                </section>
                <section id="personality" class="about-section flex" aria-labelledby="personality-title">
                ...
                <section id="pets" class="about-section flex" aria-labelledby="pets-title">
            ...
            <div class="row row-2 flex-center dir-change">
                <section id="hobbies" class="about-section flex" aria-labelledby="hobbies-title">
                ...
                <section id="celebrities" class="about-section flex" aria-labelledby="celebrities-title">
                ...
                <section id="kinlist" class="about-section flex" aria-labelledby="kinlist-title">
