    ...
    <main class="text-center">
        ...
        <div class="about-sections">
            <div class="row">
                ...
                <section id="personality" class="about-section" aria-labelledby="personality-title">
                ...
                <section id="pets" class="about-section" aria-labelledby="pets-title">
            ...
            <!-- <div class="row dir-change">
                <section id="hobbies" class="about-section" aria-labelledby="hobbies-title">
                ...
                <section id="celebrities" class="about-section" aria-labelledby="celebrities-title">
                    <h2 id="celebrities-title">Celebrity Crushes</h2>
                    <div class="celebrity-container dir-row">
                        <?php foreach ($celebrities as $celebrity => $image) : ?>
                            <img src="<?= $image ?>" alt="<?= $celebrity ?>" title="<?= $celebrity ?>">
                        <?php endforeach; ?>
                    </div>
                </section>
                <section id="kinlist" class="about-section" aria-labelledby="kinlist-title">
